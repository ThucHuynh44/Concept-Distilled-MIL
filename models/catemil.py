...
class DAttention(nn.Module):
    def __init__(self, input_dim=512, n_classes=2, dropout=0.25, act='relu', concept_path=None,rrt=None):
        ...
        self.cate = CATE(input_dim=768, ib_dim=768, interv_dim=768, concept_path=concept_path,n_classes=n_classes)
