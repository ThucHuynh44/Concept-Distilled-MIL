...
parser.add_argument('--model_type', type=str, choices=['clam_sb', 'cate_dl','clam_mb','cate_clam_sb','abmil','cate_abmil','mean_mil','max_mil','trans_mil','mamba_mil',"dsmil"], default='clam_sb', 
                    help='type of model (default: clam_sb, clam w/ single attention branch)')
parser.add_argument('--exp_code', type=str, help='experiment code for saving results')
parser.add_argument('--weighted_sample', action='store_true', default=False, help='enable weighted sampling')
parser.add_argument('--model_size', type=str, choices=['small', 'big'], default='small', help='size of model, does not affect mil')
parser.add_argument('--task', type=str, choices=['tcga_rcc',  'tcga_nsclc',"tcga_brca"])
...
#cate
parser.add_argument('--concept_path', type=str, default=None, help='concept_path directory')
...
if args.task == 'tcga_rcc':
    args.n_classes=3
    dataset = Generic_MIL_Dataset(csv_path = 'dataset_csv/tcga_rcc_subset.csv',
                            data_dir= os.path.join(args.data_root_dir, 'feature_256'),
                            shuffle = False, 
                            seed = args.seed, 
                            print_info = True,
                            label_dict = {'CCRCC':1, 'PRCC':0, "CHRCC":2},
                            patient_strat= False,
                            ignore=[])
    ...
    args.n_classes=2
    dataset = Generic_MIL_Dataset(csv_path = 'dataset_csv/tcga_nsclc_subset.csv',
                            data_dir= os.path.join(args.data_root_dir, 'feature_256'),
                            shuffle = False, 
                            seed = args.seed, 
                            print_info = True,
    ...
    args.n_classes=2
    dataset = Generic_MIL_Dataset(csv_path = 'dataset_csv/tcga_brca_subset.csv',
                            data_dir= os.path.join(args.data_root_dir, 'feature_256'),
                            shuffle = False, 
                            seed = args.seed, 
                            print_info = True,
